  ...
  return (
    ...
    >
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-5xl shadow-2xl overflow-hidden my-8 flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between bg-slate-950/60">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-mono font-bold uppercase tracking-wider text-cyan-300 bg-cyan-500/10 px-2 py-0.5 rounded border border-cyan-500/20">
              ...
              <h2 id="exercise-modal-title" className="text-lg font-black text-white mt-0.5">
                {currentGuide.title}
              </h2>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              aria-label={isSpeaking ? 'Stop Voice Cues' : 'Play Voice Cues'}
              className={`min-h-[44px] px-3.5 py-2 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 active:scale-[0.98] ${
                isSpeaking
            ...
            <button
              ...
              className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 active:scale-[0.97]"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="px-6 py-2 bg-slate-950 border-b border-slate-800/80 flex items-center gap-2 overflow-x-auto text-xs" role="tablist" aria-label="Exercise guides">
          <span className="text-slate-400 font-bold uppercase font-mono text-[10px] mr-2 shrink-0">Select Exercise:</span>
          {Object.values(EXERCISE_GUIDES).map((ex) => (
            <button
              ...
              className={`min-h-[44px] px-3.5 py-2 rounded-xl font-semibold transition-all flex items-center gap-1.5 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 active:scale-[0.98] ${
                selectedId === ex.id
        ...
        <div className="flex-1 overflow-y-auto grid grid-cols-1 lg:grid-cols-12 gap-0">
          ...
          <div className="lg:col-span-7 p-6 bg-slate-950/40 space-y-4 border-r border-slate-800/60">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-black border border-slate-800 shadow-2xl aspect-video group">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent p-4 flex flex-wrap items-center justify-between gap-2 text-xs">
                <div className="flex items-center gap-2">
                  <button
                    onClick={togglePlay}
                    aria-label={isPlaying ? 'Pause Video' : 'Play Video'}
                    className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold transition-all shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300 active:scale-[0.97]"
                  >
                  ...
                  <button
                    ...
                    className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-xl bg-slate-800/90 hover:bg-slate-700 text-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 active:scale-[0.97]"
                  >
                ...
                <div className="flex items-center gap-2">
                  {/* Speed Controls */}
                  <div className="flex bg-slate-900 border border-slate-800 rounded-xl p-1 text-[11px] font-mono" role="group" aria-label="Playback speed">
                    {[0.5, 1.0, 1.5].map((spd) => (
                      <button
                        key={spd}
                        onClick={() => setPlaybackRate(spd)}
                        aria-label={`Set speed to ${spd}x`}
                        className={`min-h-[36px] min-w-[36px] px-2.5 py-1 rounded-lg font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 ${
                          playbackRate === spd
                  ...
                  <button
                    ...
                    aria-label={showSkeleton ? 'Hide Pose Overlay' : 'Show Pose Overlay'}
                    className={`min-h-[44px] px-3 py-2 rounded-xl font-bold text-xs flex items-center gap-1.5 border transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 active:scale-[0.97] ${
                      showSkeleton
